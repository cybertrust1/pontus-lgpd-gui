      ...
      return (
        <div height={'100%'} width={'100%'} >
          ...
          <Box style={{display: "flex", justifyContent: "center", alignItems: "center"}} px={1} w={1}>
            <div style={{color: "white", paddingTop: window.innerHeight/20, paddingBottom: window.innerHeight/10, fontSize: '72px'}}>LGPD</div>
          ...
          <Box style={{display: "flex", justifyContent: "center", alignItems: "center"}} px={1} w={1}>
            <div style={{color: "white", paddingTop: window.innerHeight/20, paddingBottom: window.innerHeight/20, fontSize: '26px'}}> Selecione um painel no menu no canto superior direito
