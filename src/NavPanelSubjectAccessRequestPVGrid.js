...
class NavPanelSubjectAccessRequestPVGrid extends PVGrid
{
  ...
  componentDidMount()
  {
    ...
    colSettings[2] = {
      id: "Event.Subject_Access_Request.Metadata.Create_Date", name: "Data do Pedido", field: "sar_creation",
      sortable: true
    };
    colSettings[3] = {
      id: "Event.Subject_Access_Request.Metadata.Update_Date", name: "Data de Atualização", field: "sar_update",
      sortable: true
    };
