...
class NavPanelSubjectAccessRequestPVGrid extends PVGrid
{
  ...
  componentDidMount()
  {
    ...
    colSettings[0] = {
      id: "Event.Subject_Access_Request.Status", name: "Status", field: "sar_status", sortable: true
    };
    colSettings[1] = {
      id: "Event.Subject_Access_Request.Request_Type", name: "Tipo", field: "sar_req_type", sortable: true
    };
    colSettings[2] = {id: "Event.Subject_Access_Request.Metadata.Create_Date", name: "Data do Pedido", field: "sar_creation", sortable: true};
    colSettings[3] = {id: "Event.Subject_Access_Request.Metadata.Update_Date", name: "Data de Atualização", field: "sar_update", sortable: true};
