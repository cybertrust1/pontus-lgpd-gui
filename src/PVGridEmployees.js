...
class PVGridEmployees extends PVGrid
{
  ...
  onClickedPVGridAwarenessCampaign = (val) =>
  {
    try
    {
      ...
      colSettings[1] = {id: "Person.Natural.Full_Name", name: "Nome Inteiro", field: "Person.Natural.Full_Name", sortable: true};
      colSettings[2] = {id: "Person.Natural.Nationality", name: "Nacionalidade", field: "Person.Natural.Nationality", sortable: true};
