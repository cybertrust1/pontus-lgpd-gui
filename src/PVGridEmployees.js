...
class PVGridEmployees extends PVGrid
{
  ...
  onClickedPVGridAwarenessCampaign = (val) =>
  {
    try
    {
      ...
      colSettings[1] = {id: "Person.Full_Name", name: "Nome Inteiro", field: "Person.Full_Name", sortable: true};
      colSettings[2] = {id: "Person.Nationality", name: "Nacionalidade", field: "Person.Nationality", sortable: true};
      colSettings[3] = {id: "event_status", name: "Status da campanha", field: "event_status", sortable: false};
