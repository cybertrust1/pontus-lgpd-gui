  ...
  render()
  {
    ...
    return (
      ...
      >
        ...
        >
          {this.renderItemRaw("Pontuação", <NavPanelComplianceScores complyPanel={this} style={{height: '100%', width: '100%'}}/>,
          ...
          {this.renderItemRaw("Direitos Pessoais", <NavPanelIndividualsRights isFullMode={true} style={{
              height: '100%', width: '100%'
            }}/>,
            <Icon icon={iosPricetagsOutline}/>, <NavPanelIndividualsRightsPopup
              style={{height: '100%', width: '100%'}}/>
          )}
          {this.renderItemRaw("Solicit. de Dados", <NavPanelSubjectAccessRequest
              style={{height: '100%', width: '100%'}}/>,
            <Icon icon={download} style={{color:'purple'}}/>, <NavPanelSubjectAccessRequestPopup/>)}
          {this.renderItemRaw("Base Legal", <NavPanelLawfulBasis style={{height: '100%', width: '100%'}}/>, <Icon
            icon={balanceScale}/>, <NavPanelLawfulBasisPopup/>)}
          {this.renderItemRaw("Consentimentos", <NavPanelConsent style={{height: '100%', width: '100%'}}/>, <Icon
            icon={check}/>, <NavPanelConsentPopup/>)}
          {this.renderItemRaw("Crianças", <NavPanelChildren style={{height: '100%', width: '100%'}}/>, <Icon
            icon={ic_child_care}/>, <NavPanelChildrenPopup/>)}
          {this.renderItemRaw("Violação de Dados", <NavPanelDataBreaches style={{height: '100%', width: '100%'}}/>, <Icon
