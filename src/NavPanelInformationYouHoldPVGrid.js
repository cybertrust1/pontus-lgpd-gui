...
class NavPanelInformationYouHoldPVGrid extends PVGrid
{
  ...
  componentDidMount()
  {
    ...
    colSettings[0] = {id: "Person.Title", name: "Título", field: "Person.Title", sortable: true};
    colSettings[1] = {id: "Person.Full_Name", name: "Nome Completo", field: "Person.Full_Name", sortable: true};
    colSettings[2] = {id: "Person.Age", name: "Idade", field: "Person.Age", sortable: true};
    colSettings[3] = {id: "Person.Gender", name: "Gênero", field: "Person.Gender", sortable: true};
    colSettings[4] = {id: "Person.Nationality", name: "Nacionalidade", field: "Person.Nationality", sortable: true};
